...
export default async function SJClassicPrintPage({ params }: { params: Promise<{ id: string }> }) {
    await headers();
        ...
        <div className="w-full bg-white text-black font-sans p-8 print:p-0 print:m-0 mx-auto" style={{ maxWidth: '210mm', minHeight: '297mm' }}>
            ...
            <div className="flex justify-between items-start mb-6">
                <div className="flex-1">
                    ...
                    <div className="font-bold text-xl underline decoration-2 underline-offset-4 tracking-widest mt-2">
                        SURAT JALAN
                    </div>
                </div>
                ...
                <div className="flex-1 max-w-[350px]">
                    <div className="grid grid-cols-[100px_1fr] gap-y-2 text-sm">
                        ...
                        <div className="border-b border-black border-dotted font-mono text-xs pt-1">{delivery.deliveryNumber}</div>
                        
                        <div className="font-semibold">Jakarta,</div>
                        <div className="border-b border-black border-dotted pt-1">{format(new Date(delivery.createdAt), "dd-MM-yyyy")}</div>
                        
                        <div className="font-semibold mt-2">Kepada Yth,</div>
                        <div className="border-b border-black border-dotted mt-2 font-bold uppercase">{delivery.buyerName}</div>
                        
                        <div className="font-semibold uppercase text-xs mt-2">NO. MOBIL</div>
                        <div className="border-b border-black border-dotted mt-2 uppercase text-xs pt-1">{delivery.vehicleNumber || '....................'}</div>
                        
                        <div className="font-semibold uppercase text-xs">DRIVER</div>
                        <div className="border-b border-black border-dotted uppercase text-xs pt-1">....................</div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-4 text-sm font-semibold flex gap-2">
                Reference : <span className="border-b border-black border-dotted flex-1 max-w-[300px] inline-block">{delivery.notes || '..............................'}</span>
            </div>
            ...
            <table className="w-full border-collapse border border-black classic-table text-center text-sm">
                <thead>
                    <tr>
                        <th className="w-1/4 font-normal py-2 text-sm">Dikeluarkan oleh :</th>
                        <th className="w-1/4 font-normal py-2 text-sm">Disetujui :</th>
                        <th className="w-1/4 font-normal py-2 text-sm">Pengemudi :</th>
                        <th className="w-1/4 font-normal py-2 text-sm">Penerima :</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <div className="flex justify-between items-end mt-2 text-xs italic font-semibold">
                <div>Asli : Pengirim, Copy 1 : Penerima, Copy 3 : Arsip</div>
                <div className="text-[10px] not-italic font-normal">F-PROC-003, Rev : 01, 01 Januari 2010</div>
            </div>
        </div>
    );
}

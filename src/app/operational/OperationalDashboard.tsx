            ...
            <div className="bg-white border border-slate-100 shadow-xl shadow-slate-200/40 rounded-[2rem] overflow-hidden flex flex-col flex-1">
                <div className="p-5 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 w-full">
                        ...
                        <div className="flex w-full md:w-auto flex-wrap gap-2 text-[10px] md:text-xs font-black uppercase tracking-widest justify-center shrink-0 bg-slate-100/80 p-1.5 rounded-2xl">
                            <button 
                    ...
                    {/* Bottom Row: Date and Division Filters */}
                    <div className="grid grid-cols-2 md:flex md:flex-row md:flex-wrap items-center gap-3 w-full">
                        <input
                            type="date"
                            className="w-full md:w-auto bg-slate-100/80 border-none rounded-2xl py-2.5 px-4 text-[11px] font-black uppercase tracking-widest text-slate-600 focus:bg-white focus:ring-2 focus:ring-primary/20 transition-all outline-none h-[42px] cursor-pointer"
                            value={filterDate}
                            onChange={(e) => {
                        ...
                        {!filterDate && (
                            <>
                                <select
                                    ...
                                    className="w-full md:w-auto bg-slate-100/80 border-none rounded-2xl py-2.5 pl-4 pr-8 text-[11px] font-black uppercase tracking-widest text-slate-600 focus:bg-white focus:ring-2 focus:ring-primary/20 transition-all outline-none cursor-pointer h-[42px]"
                                >

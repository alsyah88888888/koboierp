...
async function run() {
  ...
  let count = 0;
  let md = "# Daftar Transaksi Pembayaran Parsial (Dicicil)\n\nBerikut adalah daftar seluruh Nomor Ref/Invoice yang pembayarannya dilakukan secara bertahap (berdasarkan database terkini):\n\n";
  ...
  md += `\n**Total Transaksi yang dibayar terpisah/parsial:** ${count} transaksi.\n`;

  fs.writeFileSync('/Users/alsyah/.gemini/antigravity-ide/brain/19f82881-4b65-4058-91f9-bf2d4577bf29/laporan_pembayaran_parsial.md', md);
}
